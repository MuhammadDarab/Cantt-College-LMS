const Loading = () => {
  return (
    <>
      <div className="absolute w-full h-full text-white text-4xl bg-large-tiles bg-cover"></div>
      <div className="absolute w-full h-full text-white text-4xl bg-large-tiles blur-md bg-cover"></div>
